...
<head>
  ...
  <title>Tabel Laporan Aktivitas</title>
...
<div class="wrapper">
  ...
  <?php
                          //mendapatkan id_project dari tabel
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="tabel_laporan_aktivitas.php">Tampil Tabel Laporan Aktivitas</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="print_tabel_laporan_aktivitas.php?id_project=<?=$id_project ?>" target="blank_" class="small-box-footer">Print Disini <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
...
//if ketujuh untuk QA plan            
        ...
        echo "<h2>JUMLAH DOKUMEN = ".$DATA_TOTAL."</h2>";
?>
