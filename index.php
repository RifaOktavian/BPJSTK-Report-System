...
<?php 
  ...
  $json1                   =   'http://172.26.7.223:1303/api/workload';
  $jsondata1               =   file_get_contents($json1);
  //convert json ke data array
  $data1                   =   json_decode($jsondata1, true);
  //hitung jumlah data di json
  $count1                  =   count($data1['DATA']);
  $JUMLAH_DATA1            =   $count1;
  ?>
  <!-- ./load Jumlah data Project  -->
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Report System</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <!-- col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="view_project.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
        ...
        <div class="small-box bg-warning">
          <div class="inner">
              <?php echo  "<h1>$JUMLAH_DATA1 </h1>"; ?>
                <p>Total Workload</p>
          </div>
          <div class="icon">
            <i class="ion ion-person-add"></i>
          </div>
            <a href="view_workload.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- end -->
        </div>
